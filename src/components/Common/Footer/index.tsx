        ...
        <nav className="flex justify-between gap-10 w-full pb-7">
          {navItems.map(({ links, id }, index) => (
            <div key={id ?? index} className="flex flex-col text-sm">
              {links?.map(({ link, id }, i) => (
                <CMSLink key={id ?? i} {...link} className="first:font-bold first:text-white" />
              ))}
            </div>
          ))}
        </nav>
        <nav className="flex items-start w-full justify-between py-5 border-t border-[rgba(255,255,255,0.35)]">
          <div className="flex items-center gap-3 fill-colorFooterForeground">
            {[
              {
                href: 'https://www.facebook.com/OptiTrack',
                title: 'facebook logo',
                svg: (
              ...
              {
                href: 'https://www.instagram.com/optitrack/',
              ...
              {
                href: 'https://www.linkedin.com/company/optitrackmocap',
                title: 'linkedin logo',
                svg: (
                  <path
              ...
              {
                href: 'https://vimeo.com/optitrack',
                title: 'vimeo logo',
                svg: (
              ...
              {
                href: 'https://www.youtube.com/@OptiTrackMoCap',
                title: 'youtube logo',
                svg: (
          ...
          <div className="flex flex-col items-end text-sm">
            <div>&copy; {new Date().getFullYear()} NaturalPoint, Inc. DBA OptiTrack</div>
            <div>
              <ThemeSelector />
            </div>
          </div>
