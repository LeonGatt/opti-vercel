...
const SEED_DUMP_URL =
  env.SERVER_URL +
  "/seed/demo-payblocks---demo-payblocks.trieb.work---1739813600714.json";
...
const BackupDashboard: React.FC = async ({ user }: { user: User | null }) => {
  ...
  return (
    <div className="backup-dashboard-2">
      ...
      <p>
        Payblocks is a comprehensive website builder toolkit that combines
        PayloadCMS&apos;s powerful content management capabilities with
        shadcn/ui&apos;s modern components and shadcnblocks.com&apos;s extensive
        block library. Visit the{" "}
        <a
          href="https://docs.shadcnblocks.com/payload/getting-started/"
          target="_blank"
        >
          documentation
        </a>{" "}
        to guide you through setting up, configuring, and extending your
        Payblocks project.
      </p>
        ...
        <span>
          ...
          >
            <div>
              ...
              <br />
              After seeding you will be automatically logged out and have to
              login with your previously created admin user again.
              <br />
          ...
          Seed your DB now to get a first preview how your project could look
          like with some example pages.
        </span>
      )}
    </div>
  );
