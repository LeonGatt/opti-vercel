    ...
    <TrackingScriptWrapper
      ...
      scriptContent={`
       (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
        ...
        'https://www.googletagmanager.com/gtm.js?id='+i+dl+ '&gtm_auth=${process.env.NEXT_PUBLIC_GTM_AUTH}&gtm_cookies_win=x';f.parentNode.insertBefore(j,f);
  ...
  return (
    <>
      {process.env.NEXT_PUBLIC_GOOGLE_TAG_MANAGER_ID && (
        <noscript>
          <iframe
            src={`https://www.googletagmanager.com/ns.html?id=${process.env.NEXT_PUBLIC_GOOGLE_TAG_MANAGER_ID}&gtm_auth=${process.env.NEXT_PUBLIC_GTM_AUTH}&gtm_cookies_win=x`}
            height="0"
            width="0"
