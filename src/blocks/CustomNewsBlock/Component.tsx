...
const CustomNewsBlock: React.FC<GalleryBlock & { publicContext: PublicContextProps }> = ({
  tagline = 'Latest News & Updates',
  elements,
  publicContext,
}) => {
              ...
              elements.map((item) => {
                ...
                return (
                  ...
                  >
                    <a
                      href={item.link?.url || '#'}
                      className="group flex flex-col justify-between rounded-xl py-6 sm:py-5"
                    >
                      <div>
                      ...
                      {firstNode && (
                        <RichText
                          ...
                          overrideStyle={{
                            ...
                            p: 'mb-8 line-clamp-2 min-h-[80px] text-sm text-muted-foreground md:mb-12 md:text-base lg:mb-9',
                          }}
                          withWrapper={false}
                        />
                      )}
...
export default CustomNewsBlock
