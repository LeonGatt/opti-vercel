          ...
          <div className="flex items-center gap-6 lg:gap-12">
            <div className="flex flex-col items-center gap-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="whitespace-nowrap text-xs lg:text-sm">Apple Store</span>
              </div>
            </div>
            <div className="flex flex-col items-center gap-1">
              <div className="flex items-center gap-2 text-2xl font-medium">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="whitespace-nowrap text-xs lg:text-sm">Play Store</span>
              </div>
            </div>
            <div className="flex flex-col items-center gap-1">
              <div className="flex items-center gap-2 text-2xl font-medium">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="whitespace-nowrap text-xs lg:text-sm">Trustpilot</span>
              </div>
            </div>
          </div>
        </div>
