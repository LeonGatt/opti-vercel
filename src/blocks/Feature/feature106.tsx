          ...
          {features.map((feature) => (
            ...
            >
              <AccordionTrigger className="group relative items-start text-left hover:no-underline data-[state=active]:bg-background">
                <span className="absolute -left-7 -top-4 bottom-0 h-full w-[3px] bg-primary transition-opacity duration-300 group-data-[state=closed]:opacity-0"></span>
        ...
        >
          <TabsList className="flex flex-col gap-px bg-border">
            {features.map((feature) => (
              ...
              >
                <span className="absolute inset-y-0 left-0 h-full w-[3px] bg-primary transition-opacity duration-300 group-data-[state=inactive]:opacity-0"></span>
