...
const tabs = [
  {
    ...
    icon: <MessageCircleMore className="size-8 text-primary lg:size-10" strokeWidth={1.5} />,
  },
  {
    title: 'Integrations',
    image: '/images/block/placeholder-2.svg',
    icon: <Blocks className="size-8 text-primary lg:size-10" strokeWidth={1.5} />,
  },
  {
    title: 'Collaboration',
    image: '/images/block/placeholder-3.svg',
    icon: <Users className="size-8 text-primary lg:size-10" strokeWidth={1.5} />,
  },
  {
    title: 'Automation',
    image: '/images/block/placeholder-4.svg',
    icon: <Workflow className="size-8 text-primary lg:size-10" strokeWidth={1.5} />,
  },
  {
    title: 'Customization',
    image: '/images/block/placeholder-5.svg',
    icon: <LayoutPanelTop className="size-8 text-primary lg:size-10" strokeWidth={1.5} />,
  },
  {
    title: 'Security',
    image: '/images/block/placeholder-6.svg',
    icon: <Fingerprint className="size-8 text-primary lg:size-10" strokeWidth={1.5} />,
  },
]
