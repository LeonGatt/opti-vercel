      ...
      <div className="container">
        <div className="flex flex-col gap-8 md:flex-row-reverse">
          ...
          <div className="flex shrink-0 flex-col md:w-1/2 md:pr-8 lg:pr-24 lg:text-left 2xl:pr-32">
            <h2 className="mb-6 text-pretty text-3xl font-bold lg:text-5xl">Feature Description</h2>
              ...
              {features.map((feature, i) => (
                ...
                >
                  ...
                  <div className="hidden text-sm font-medium group-data-open:block">
                    <p className="my-4 text-muted-foreground lg:my-6">{feature.description}</p>
                    <a
                      href="#"
