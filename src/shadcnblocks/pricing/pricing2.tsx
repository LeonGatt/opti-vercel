          ...
          <div className="flex flex-col items-stretch gap-6 md:flex-row">
            <Card className="flex w-80 flex-col justify-between text-left">
              <CardHeader>
                ...
                <p className="text-muted-foreground">Billed {isYearly ? '$180' : '$228'} anually</p>
              </CardHeader>
              <CardContent>
            ...
            <Card className="flex w-80 flex-col justify-between text-left">
              <CardHeader>
                ...
                <span className="text-4xl font-bold">{isYearly ? '$35' : '$49'}</span>
                <p className="text-muted-foreground">Billed {isYearly ? '$420' : '$588'} anually</p>
              </CardHeader>
              <CardContent>
                <Separator className="mb-6" />
