      ...
      <div className="container">
        <div className="mx-auto mb-20 max-w-screen-lg text-center">
          ...
          <p className="text-muted-foreground lg:text-xl">
            Check out our affordable pricing plans below and choose the one that suits you best. If
            you need a custom plan, please contact us.
          </p>
        </div>
        <div className="mx-auto grid max-w-screen-sm rounded-md border text-center lg:max-w-none lg:grid-cols-4 lg:border-x-0 lg:border-y">
          <p className="px-6 pb-2 pt-6 text-3xl font-semibold lg:order-1">Free</p>
          ...
          <p className="bg-muted px-6 pb-2 pt-6 text-3xl font-semibold lg:order-2">Pro</p>
          ...
          <div className="border-b bg-muted p-6 text-left lg:order-18 lg:border-b-0 lg:border-t">
            <div className="hidden lg:block">
              <p className="mb-2 text-lg font-semibold">Everything in Free, and:</p>
              <ul className="mb-4 space-y-4">
          ...
          <p className="px-6 pb-2 pt-6 text-3xl font-semibold lg:order-3">Premium</p>
          ...
          <div className="border-b p-6 text-left lg:order-19 lg:border-b-0 lg:border-t">
            <div className="hidden lg:block">
              <p className="mb-2 text-lg font-semibold">Everything in Pro, and:</p>
              <ul className="mb-4 space-y-4">
          ...
          <p className="px-6 pb-2 pt-6 text-3xl font-semibold lg:order-4">Entreprise</p>
          ...
          <div className="p-6 text-left lg:order-20 lg:border-t">
            <div className="hidden lg:block">
              <p className="mb-2 text-lg font-semibold">Everything in Premium, and:</p>
              <ul className="mb-4 space-y-4">
